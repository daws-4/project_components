...
import SelectLocalidadLinea from "@/components/SelectGroup/SelectLocalidadLinea";
...
const AddLinea = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const confirmUpdate = window.confirm("¿Estás seguro de que deseas añadir una nueva línea?");
        if (confirmUpdate) {
            try {
                    ...
                    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        ...
                        <div className="p-7">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                                    <div className="w-full sm:w-1/2">
                                        <SelectLocalidadLinea onChange={handleLocalidadChange} /></div>
                                    <div className="w-full sm:w-1/2">
                                        <label
                                            className="mb-3 block text-sm font-medium text-black dark:text-white"
                                            htmlFor="phoneNumber1"
